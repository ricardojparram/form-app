...
export default function HomeScreen({ navigation }) {
  ...
  return (
    <ScrollView>
      <SafeAreaView className="flex-1 items-center gap-5 bg-theme-background">
        <InfoCard
          title="Ventas |"
          subtitle="día"
          iconName="currency-usd"
          number={data_1 ? data_1.venta : <ActivityIndicator animating={true} />}
        />
        ...
        <InfoCard
          ...
          number={data_2 ? data_2.compra : <ActivityIndicator animating={true} />}
        />
        ...
        <InfoCard
          title="Proveedores"
          iconName="bank"
          number={data ? data.proveedor : <ActivityIndicator animating={true} />}
        />
